...
*/
function flatio_customizer_controls(){

	wp_register_script( 'flatio_customizer_top_buttons', get_template_directory_uri() . '/js/customizer-top-buttons.js', array( 'jquery' ), true  );
	wp_enqueue_script( 'flatio_customizer_top_buttons' );

	wp_localize_script( 'flatio_customizer_top_buttons', 'customBtns', array(
		'prodemo' => esc_html__( 'Demo Premium version', 'flatio' ),
        'proget' => esc_html__( 'Get Premium version', 'flatio' )
	) );
}
add_action( 'customize_controls_enqueue_scripts', 'flatio_customizer_controls' );
